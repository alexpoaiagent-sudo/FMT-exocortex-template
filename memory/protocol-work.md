...
- Каталог сервисов: `DP.MAP.002` в Knowledge MCP (`search("каталог сервисов", source_type="pack")`)
...
| Перед предложением архитектурного решения | АрхГейт (CLAUDE.md § 5): таблица ЭМОГСС, порог ≥8 |
