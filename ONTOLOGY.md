...
> Экзокортекс — часть 4-уровневой системы. Ты получаешь шаблон (L3), настраиваешь под себя (L4) и подключаешься к платформе (L2).
...
| Уровень | Что для тебя | Как обновляется |
|---------|-------------|-----------------|
...
> Подробная модель: [DS-ecosystem-development/11-platform-levels.md](https://github.com/TserenTserenov/DS-ecosystem-development)
